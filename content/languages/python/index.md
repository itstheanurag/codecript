...
- [Introduction](/languages/python/001-introduction)
- [Variables and Types](/languages/python/002-variables-and-types)
- [Functions and Scope](/languages/python/006-functions)

### Batch 2: Logic & Data
Deep dive into lists, dictionaries, and the underlying CPython engine.
- [Lists](/languages/python/007-lists)
- [Dictionaries and Sets](/languages/python/008-dictionaries-and-sets)
- [The Python Engine (CPython)](/languages/python/009-python-engine)

### Batch 3: Systems & Performance
Understand the complex internals that make Python powerful (and the trade-offs involved).
- [Memory Management and the GIL](/languages/python/013-memory-management)
- [Concurrency & Parallelism](/languages/python/015-concurrency-and-parallelism)
- [Asynchronous Programming](/languages/python/016-asynchronous-programming)

### Batch 4: The Pro Level
Master high-level patterns like Decorators, Generators, and OOP.
- [Magic Methods (Dunders)](/languages/python/019-magic-methods)
- [Iterators and Generators](/languages/python/020-iterators-and-generators)
- [Classes and OOP](/languages/python/022-classes-and-oop)
